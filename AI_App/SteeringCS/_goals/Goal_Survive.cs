...
{
    public class Goal_Survive : GoalComponent
    {
        // TODO Remove. This is only used for debugTexts.
        Hero hero;

        // TODO Remove. This is only used for debugTexts.
        public Goal_Survive(string name, List<Goal> subgoals, Hero hero) : base(name, subgoals)
        {
            started = false;
            done = false;
            this.hero = hero;
        ...
        public Goal_Survive(string name, List<Goal> subgoals) : base(name, subgoals)
        {
            started = false;
            done = false;
        }
